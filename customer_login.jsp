...
<input type="hidden" id="status" value="<%= request.getAttribute("status")%>">
    <div class="box-form">
        ...
        <button class="btn" data-btn><a href="manager_login.jsp">Manager Login</a></button>
    <br>
    <br>
            <p>Don't have an account? <a href="#">Create Your Account</a> it takes less than a minute</p>
            <div class="inputs">
            <form method="post" action="cust_login_servlet">
                <input type="email" name="cusername" placeholder="Username">
                <br>
